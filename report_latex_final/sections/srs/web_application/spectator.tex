...
\begin{figure}[H]
    ...
    \caption{Horse Spectator Prediction}
\end{figure}


\subsubsection{Schedule and Results}
...
\begin{figure}[H]
    ...
    \caption{Horse Spectator Schedule and Results}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Horse Spectator Personal Profile}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/web_application/spectator/top10_spectators_leaderboard.png}
    \caption{Top 10 Spectators Prediction Leaderboard}
\end{figure}